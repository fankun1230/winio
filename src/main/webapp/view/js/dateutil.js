/**
    ...
    */
    ...
    /**
    *  ?   ?  ?   ?   
    * @param date Date   ??yyyy-MM-dd HH:mm:ss,   ?      ?     ?  , §Ş ?        
    */
    ...
    */
    ...
    month = parseInt(dateStr.substr(start, 2),10) - 1;
    }
    var day = 0;
    if((start = formatStr.indexOf('dd')) > -1 && start < len){
    	
    day = parseInt(dateStr.substr(start, 2), 10);
    }
    var hour = 0;
    if( ((start = formatStr.indexOf('HH')) > -1 || (start = formatStr.indexOf('hh')) > 1) && start < len){
    hour = parseInt(dateStr.substr(start, 2), 10);
    }
    var minute = 0;
    if((start = formatStr.indexOf('mm')) > -1  && start < len){
